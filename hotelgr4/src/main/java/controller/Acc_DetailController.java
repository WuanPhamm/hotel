...
public class Acc_DetailController extends HttpServlet{	
	/**
	 * 
	 */
		...
		if (id_raw != null) {
			try {
				...
				if (cus != null) {
					...
					req.getRequestDispatcher("/customer/acc_detail.jsp").forward(req, resp);
				} else {
					resp.getWriter().println("Không tìm thấy khách hàng với ID = " + id);
				}
